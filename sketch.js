...
function Animation1()
{
    ...
    this.draw = function()
    {
        ...
        fill("black");
        textSize(20);
        text(c, width/2, height/2 - 265, 300, 300);
        text(e, width/2 + 85, height/2 - 135, 300, 300);
...
function Animation2()
{
    this.draw = function()
    {
        ...
        strokeWeight(10);
        stroke("white");
        line(200, height/2, 1100, height/2);

        //creating a variable for distance 4
        let distance4 = dist(mouseX, mouseY, 150, height/2 - 60);

        //creating a variable for distance 5
        let distance5 = dist(mouseX, mouseY, 450, height/2 - 60);

        //creating a variable for distance 6
        let distance6 = dist(mouseX, mouseY, 750, height/2 - 60);

        //creating a variable for distance 7
        let distance7 = dist(mouseX, mouseY, 1050, height/2 - 60);
        ...
        if(isOverHeart == true)
        {
            image(year1, 150, height/2 - 250, year1.width/6, year1.height/6);
            strokeWeight(1);
            text("Year 1", 160, height/2 - 85, 300, 300);
        } 
        image(blueheart, 150, height/2 - 60, blueheart.width/6, blueheart.height/6);

        //creating second heart with interaction on timeline
        if(isOverHeart2 == true)
        {
            image(year2, 430, height/2 - 260, year2.width/20, year2.height/20);
            strokeWeight(1);
            text("Year 2", 460, height/2 - 85, 300, 300);
        }
        image(blueheart, 450, height/2 - 60, blueheart.width/6, blueheart.height/6); 

        //creating third heart with interaction on timeline
        if(isOverHeart3 == true)
        {
            image(year3, 700, height/2 - 250, year3.width/8, year3.height/8);
            strokeWeight(1);
            text("Year 3", 750, height/2 - 90, 300, 300);
        }
        image(blueheart, 750, height/2 - 60, blueheart.width/6, blueheart.height/6);

        //creating fourth heart with interaction on timeline
        if(isOverHeart4 == true)
        {
            image(year4, 1010, height/2 - 250, year4.width/20, year4.height/20);
            strokeWeight(1);
            text("Year 4", 1060, height/2 - 90, 300, 300);
        }
        image(blueheart, 1050, height/2 - 60, blueheart.width/6, blueheart.height/6);
        ...
        strokeWeight(1);
        textSize(20);
        text(f, width/2 - 350, height/2 - 350, 1000, 1000);
        text(g, width/2 + 200, height/2 - 310, 300, 300);
...
function Animation3()
{
    this.draw = function()
    {
        ...
        strokeWeight(1);
        textSize(20);
        text(h, width/2 - 500, height/2 - 240, 1000, 1000);
        text(i, width/2 + 200, height/2 - 200, 300, 300);
...
function Animation4()
{
    this.draw = function()
    {
        ...
        let distance11 = dist(mouseX, mouseY, 150, height/2 - 60);

        //creating a variable for distance 12
        let distance12 = dist(mouseX, mouseY, 450, height/2 - 60);

        //creating a variable for distance 13
        let distance13 = dist(mouseX, mouseY, 750, height/2 - 60);
        ...
        if(isOverStar == true)
        {
            image(january, 130, height/2 + 55, january.width/20, january.height/20);
            strokeWeight(1);
            fill("black");
            text("January", 170, height/2 + 25, 300, 300);
        } 
        image(star, 150, height/2 - 60, star.width/5, star.height/5);

        //creating second star with interaction on timeline
        if(isOverStar2 == true)
        {
            image(march, 420, height/2 + 55, march.width/20, march.height/20);
            strokeWeight(1);
            fill("black");
            text("March", 475, height/2 + 25, 300, 300);
        }
        image(star, 450, height/2 - 60, star.width/6, star.height/6); 

        //creating third star with interaction on timeline
        if(isOverStar3 == true)
        {
            image(april, 700, height/2 + 55, april.width/20, april.height/20);
            strokeWeight(1);
            fill("black");
            text("April", 775, height/2 + 25, 300, 300);
        }
        image(star, 750, height/2 - 60, star.width/6, star.height/6);
        ...
        fill("white");
        textSize(20);
        text("Spring 2018", 50, 650, 300, 300);
